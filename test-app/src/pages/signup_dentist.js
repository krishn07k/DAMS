  ...
  <form>
    <h1 className="Heading_signup" >SIGN-UP FOR DENTIST</h1><hr/>
        <div  className="container_signup">
          ...
          <label for="dentalid">
            <b>Dental-id</b>
            <input className="signup_inputfield_" type="text" placeholder="Enter your Dental-id" name="dentalid" required/> <br/>
          </label>
          ...
          <label for="address">
            <b>Address</b>
            <input className="signup_inputfield_" type="text" placeholder="Enter your Denstistry address" name="address" required/><br/>
          </label>
