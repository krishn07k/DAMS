...
import './changing_user_id.css';

const changing_user_id = () => {
    return(
        <body className="chid_body">
            ...
            <div class="chid_title">
                Change email ID
            </div>

            <div class="chid_sub_title">
                Enter your new Email ID
            </div>

            <div class="chid_text1">
                New Email ID
            </div>
            ...
            <div class="chid_new_email">
                ...
                <div class="chid_email_icon">
                    <img src="icons/mail.png" alt="email_icon" class="chid_email_icon_image" />
                </div>
