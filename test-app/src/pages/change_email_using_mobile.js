...
import './change_email_using_mobile.css';

const change_email_using_mobile = () => {
    return(
        <body className="ceum_body">
            ...
            <div class="ceum_main_title">
                Change Email ID using mobile number
            </div>

            <div class="ceum_content">
                <div class="ceum_content_heading">Follow the steps to change your Email ID</div>
            ...
            <div class="ceum_input_box">
                ...
                <div class="ceum_phone_icon">
                    <img src="icons/phone.png" alt="phone_image" class="ceum_phone_icon_image" />
                </div>

                <div class="ceum_input">
                    <input type="text" class="ceum_input_field" />
                </div>
